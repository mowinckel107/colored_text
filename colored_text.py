...
def print_text_red(text : str, print_end : Optional[str] = "\n"):
    ansi_color_code : int = 31 # normal red

    __turn_text_colur(ansi_color_code)
...
def print_text_green(text : str, print_end : Optional[str] = "\n"):
    ansi_color_code : int = 92 # bright green
...
def print_text_yellow(text : str, print_end : Optional[str] = "\n"):
    ansi_color_code : int = 93 # bright yellow
...
def print_text_blue(text : str, print_end : Optional[str] = "\n"):
    ansi_color_code : int = 94 # bright blue
...
def red_text(text : str) -> str:
    ...
    colored_text : str = __text_colur(ansi_color_code)
    colored_text      += text
